...
<div id="apps-root" style="display:none;"><#-- NOTE: webrootVue component attaches here, uses this and below for template -->
    ...
    <input type="hidden" id="confBasePath" value="${ec.web.servletContext.contextPath}/wcinternal">
    <input type="hidden" id="confLinkBasePath" value="${ec.web.servletContext.contextPath}/wcapp">
    ...
    <q-layout view="hHh LpR fFf">
        <q-header class="${headerClass}" id="top"><q-toolbar style="font-size:15px;">
            ...
            <#-- nav plugins See in root WeCreateVue.qvt.ftl -->

            <#-- notify history See in root WeCreateVue.qvt.ftl -->

            <#-- screen history menu See in root WeCreateVue.qvt.ftl -->
